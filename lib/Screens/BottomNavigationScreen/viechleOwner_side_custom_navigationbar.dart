...
import 'ProfileScreen/vehicle_owner_profile.dart';


class ViechleOwnerSideCustom_BottomBar extends StatefulWidget {
  int selectedIndex =0;
  ViechleOwnerSideCustom_BottomBar({required this.selectedIndex});
  @override
  _BottomBar createState() => _BottomBar();
}

class _BottomBar extends State<ViechleOwnerSideCustom_BottomBar> {

  // selectedIndex = 0;

  static List<Widget> _widgetOptions = <Widget>[
    ViechleOwnerHomeScreen(),
    ViechleOwnerMyRequestScreen(),
    VehicleOwnerProfile(),
