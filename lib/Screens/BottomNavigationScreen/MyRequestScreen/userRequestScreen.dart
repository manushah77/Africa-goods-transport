...
class _UserRequestScreenState extends State<UserRequestScreen> {
  ...
  Future<void> dropOffDialog(String text1,String text2,String text3,String text4,String text5) async {
    showDialog(
                            ...
                            child: Row(
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    text1.isEmpty || text1 == 'null' ? 'No Drop Off' : text1 ,
                                    style: TextStyle(
                                      fontFamily: 'Douro',
                                      fontSize: 14,
                            ...
                            child: Row(
                              children: [
                                Padding(
                                  ...
                                  const EdgeInsets.only(left: 8.0),
                                  child: Text(
                                    text2.isEmpty || text2 == 'null' ? 'No Drop Off' : text2 ,
                                    style: TextStyle(
                                      fontFamily: 'Douro',
                                      fontSize: 14,
                                      fontWeight: FontWeight.w300,
                            ...
                            child: Row(
                              children: [
                                Padding(
                                  ...
                                  const EdgeInsets.only(left: 8.0),
                                  child: Text(
                                    text3.isEmpty || text3 == 'null' ? 'No Drop Off' : text3 ,
                                    style: TextStyle(
                                      fontFamily: 'Douro',
                                      fontSize: 14,
                                      fontWeight: FontWeight.w300,
                            ...
                            child: Row(
                              children: [
                                Padding(
                                  ...
                                  const EdgeInsets.only(left: 8.0),
                                  child: Text(
                                    text4.isEmpty || text4 == 'null' ? 'No Drop Off' : text4 ,
                                    style: TextStyle(
                                      fontFamily: 'Douro',
                                      fontSize: 14,
                                      fontWeight: FontWeight.w300,
                            ...
                            child: Row(
                              children: [
                                Padding(
                                  ...
                                  const EdgeInsets.only(left: 8.0),
                                  child: Text(
                                    text5.isEmpty || text5 == 'null' ? 'No Drop Off' : text5 ,
                                    style: TextStyle(
                                      fontFamily: 'Douro',
                                      fontSize: 14,
                                      fontWeight: FontWeight.w300,
                              ...
                              onTap: () async {
                                ...
                                try {
                                  await addRequest().then((value) {
                                    Get.offAll(() => UserSideCustom_BottomBar(
                                        selectedIndex: 0));
                                   ...
                                   //      'priority': 'high',
                                   //      'notification': {
                                   //        'title': 'African Goods Tranport',
                                   //        'body': 'Attention! $name post a request',
                                   //        'android_channel_id': 'transport_app'
                                   //      },
                                   //      'data': {'id': '1111122'}
                                   //    };
                                   //
                                   ...
                                   //      'Authorization':
                                   //      'key=AAAADhmgFl8:APA91bHx5Wse64SIKWhV0S0jmZg9nKiMwjzrZcCHajTwHZmD-LfReRMriIhjHmNBySYCIUokc8LgHG1iC1AVl80L7SVZGEhVOVVEhEU5uNZNZYj4DoVHKwJBFv19BEagUWC1AviVWSbK'
                                   //    };
                                   //
